...
![Scribe app screenshot](./scribe.png)

A small app for browsing meetings, viewing transcripts, and chatting with the Scribe assistant.
...
### Approach
I approached this challenge with the mindset that it's a prototype to demonstrate the core Scribe product loop of recording a meeting on an external platform.
...
Additional Scribe features like search, channels, and integrations were cut out so the prototype could focus on demonstrating the core capture > live notes > summary loop.
...
- Canned responses: Ask Scribe assistant uses canned responses, no LLM connection
